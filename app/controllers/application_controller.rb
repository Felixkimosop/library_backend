...
#   def authorized_user
#     render json: { message: 'Please log in as a user' }, status: :unauthorized unless logged_in? && !!current_user
#   end

#   def authorized_admin
#     render json: { message: 'Please log in as an admin' }, status: :unauthorized unless logged_in? && !!current_admin
#   end
